...
public class OnStart : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject blocksPanel;

    [SerializeField]
    GameObject propertiesPanel;

    [SerializeField]
    GameObject runnerFieldsPanel;
    ...
    void Start()
    {
        ...
        var runnerPrefab = Resources.Load<Runner>("Runner/RunnerUfo");
        ...
        runnerFieldsPanelObj.Initialize(runner, fieldsValues);
        ...
        runner.Initialize(plane.transform, startBlock, workspace);
    }
